...
<body class="building_version" data-spy="scroll" data-target=".header">
    <div id="app" >
        <nav  class="navbar navbar-expand-md navbar-red bg-red shadow-sm" style="background: black;">
            <div class="container" >
                <a class="navbar-brand" href="{{ url('/') }}" style="color: white; text-decoration-style: bold;" >
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="color: white; text-decoration: bold;">
        ...
        {{-- DRAFT --}}
        {{-- <div>
            <p style="color: blue; text-decoration: bold;">HELLLLHELLLLHELLLLHELLLLHELLLLHELLLLHELLLLHELLLLHELLLL</p>
        </div> --}}
        <br>
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-hidden">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-hidden">
                           <div class="gem-contacts-item gem-contacts-phone">
                              <a class="phone-icon" href="#" target="_blank" title="phone"><i class="fa fa-phone" aria-hidden="true"></i>+855-81 591 594 / +855 98 470 261</a>
                           </div>
                        </div>
         ...
         <div class="container">
            <div class="section-title row text-center">
               <div class="col-md-8 col-md-offset-2">
                  <h3>Feedbacks</h3>
                  <p class="lead">These our feedbacks from our customer. Most of them are satified with BR's services.</p>
               </div>
               <!-- end col -->
            </div>
            <!-- end title -->
